...
(function(){
  ...
  document.querySelectorAll('a,button,.pcard,.sk-category,.ccard,.cbtn,.close-btn').forEach(function(el){
...
var obs=new IntersectionObserver(function(entries){
  entries.forEach(function(e){
    if(e.isIntersecting){
      ...
      e.target.querySelectorAll('.sk-fill').forEach(function(b){setTimeout(function(){b.style.width=b.getAttribute('data-w')+'%';},300);});
